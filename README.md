# JPEGView-Static Absolute Image Viewer for Windows
...
I plan to add a lightweight local-running AI image super-resolution feature to one of the text releases.

## The concept

This is a fork of [Sylikc's JpegView](https://github.com/sylikc/jpegview) that eliminates all legacy garbage,
but gives the outstanding support of all modern 64-bit Windows systems starting from Windows 10 (and unofficially from Windows 7).
